...
function findAddress(text) {
  ...
  return {
    ...
    title: 'כתובת זוהתה',
    actions: [
      { id: 'maps', label: 'נווט עם Google Maps 🗺️', url: `https://www.google.com/maps/search/?api=1&query=${encoded}` },
      { id: 'waze', label: 'נווט עם Waze 🚗', url: `https://waze.com/ul?q=${encoded}&navigate=yes` }
    ]
  };
}
